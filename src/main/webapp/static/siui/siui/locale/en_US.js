...
*
* License : http://www.siui.com/license
*/
...
if (si.FileUpload) {
    si.FileUpload.prototype.buttonText = "Browse..."
}
if (si.HtmlFile) {
    si.HtmlFile.prototype.buttonText = "Browse..."
}
...
-----------------------------------------------------------------------------*/
if (window.si.Gantt) {
    si.GanttView.ShortWeeks = [
        "Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"
    ];
    si.GanttView.LongWeeks = [
